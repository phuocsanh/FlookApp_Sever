...
module.exports = {
  ...
  likeComment : async (req, res) => {
    try {
      ...
      console.log("🚀 ~ file: comment.js ~ line 30 ~ likeComment: ~ idUser", idUser)
    
      const commentId = req.query.commentId
      console.log("🚀 ~ file: comment.js ~ line 33 ~ likeComment: ~ commentId", commentId)
      
      
      const comment = await models.comments.findById(commentId);
      // console.log("🚀 ~ file: comment.js ~ line 37 ~ likeComment: ~ comment", comment)
  ...
  searchCommentChapter: async (req, res) =>{
    console.log("🚀 ~ file: comment.js ~ line 83 ~ searchCommentChapter: ~ searchCommentChapter",)
    try {
      const chapterId = req.query.chapterId
      console.log("🚀 ~ file: comment.js ~ line 86 ~ searchCommentChapter: ~ chapterId", chapterId)
